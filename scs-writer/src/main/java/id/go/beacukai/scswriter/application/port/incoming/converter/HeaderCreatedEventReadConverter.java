...
import static id.go.beacukai.scs.sharedkernel.domain.event.HeaderCreatedEvent.Payload;

@ReadingConverter
public class HeaderCreatedEventReadConverter implements Converter<Row, HeaderCreatedEvent> {

    @Override
    public HeaderCreatedEvent convert(Row source) {
